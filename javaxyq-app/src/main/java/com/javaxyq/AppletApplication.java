...
public class AppletApplication extends JApplet implements Application, GameWindow {
    ...
    @Override
    public void start() {
        Thread loadingThread = new Thread(this::startup);
...
//======================== GameWindow Implements =============================//
    ...
    public void initApplet(String[] args) {
        log.info("");
        log.info("-------------------------");
        log.info("cache dir: " + CacheManager.getInstance().getCacheBase());
    ...
    public void init(Context context) {
        ...
        try {
            ...
            log.warn("列出系统属性时发生异常：" + e.getMessage());
            //e.printStackTrace();
        }
        initApplet(null);
...
//		dataManager.saveData();
     ...
     *
     * @param source 触发Action的源对象
     * @param args   cmd动作的actiomCommand
     *               ,而非类名
     */
